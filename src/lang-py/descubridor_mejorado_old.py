...
- Comunicacion reducida
- Integracion numerica optimizada (solve_ivp)
- Soporte para familias fisicas y matematicas
- Tolerancia a fallos y timeouts configurables
CON TIMESTAMPS EN MENSAJES DEL MAESTRO
"""
...
# ============================================================================
# 4. PROGRAMA PRINCIPAL CON BALANCE DE CARGA DINAMICO Y TIMESTAMPS
# ============================================================================
...
def main():
    ...
    parser.add_argument('--timeout', type=int, default=3600,
                        help='Timeout por tarea en segundos (defecto 3600)')
    ...
    try:
        if rank == 0:
            ...
            # Generar graficos para los mejores modelos
